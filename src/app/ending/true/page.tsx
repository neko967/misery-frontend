...
export default function Home() {
  ...
  const storyTexts = [
    ...
    '彼らの足取りは、新しい朝の光の中で決意に満ちていた。少女の声なき声を聞き、その悲劇に光を当てるために。洋館の謎を背負った二人は、未解決の疑問を手がかりに新たな物語を紡ぎ始める。',
    '彼らの旅は終わらず、ただ一つの結論に向かって進んでいく。それは、忘れ去られた魂が伝えたかった真実を、世に知らしめるための旅だった。',
  ];
